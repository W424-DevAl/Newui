...
local Library do 
    ...
    Library.Sections.index = Library.Sections
    Library.Pages._index = Library.Pages
        ...
        Instances.FadeItem = function(self, Visibility, Speed)
            ...
            for Index, Value in Descendants do 
                ...
                if type(TransparencyProperty) == "table" then 
                    for , Property in TransparencyProperty do 
    ...
    Library.Unload = function(self)
        ...
        for , Object in pairs(self.ToClean) do
            pcall(function()
    ...
    Library.Connect = function(self, Event, Callback, Name)
        Name = Name or StringFormat("connectionnumber%s%s", self.UnnamedConnections + 1, HttpService:GenerateGUID(false))
    ...
    Library.NextFlag = function(self)
        ...
        return StringFormat("flagnumber%s%s", FlagNumber, HttpService:GenerateGUID(false))
    end
    ...
    Library.ChangeTheme = function(self, Theme, Color)
        ...
        for , Item in self.ThemeItems do
    ...
    do 
        ...
        Library.Window = function(self, Data)
            ...
            local Items = { } do
                ...
                do
                    ...
                    Items["1"] = Instances:Create("Frame", {
                        ...
                        BorderSizePixel = 0,
                        BackgroundColor3 = FromRGB(255, 255, 255)
                    })  Items["1"]:AddToTheme({BackgroundColor3 = "Background"})
                    
                    Items["2"] = Instances:Create("Frame", {
                        Parent = Items["LeftBottomPixels"].Instance,
                        Name = "\0",
                        BorderColor3 = FromRGB(0, 0, 0),
                        AnchorPoint = Vector2New(0, 1),
                        ...
                        BorderSizePixel = 0,
                        BackgroundColor3 = FromRGB(255, 255, 255)
                    })  Items["2"]:AddToTheme({BackgroundColor3 = "Background"})
                    
                    Items["3"] = Instances:Create("Frame", {
                        Parent = Items["LeftBottomPixels"].Instance,
                        Name = "\0",
                        BorderColor3 = FromRGB(0, 0, 0),
                        AnchorPoint = Vector2New(0, 1),
                        ...
                        BorderSizePixel = 0,
                        BackgroundColor3 = FromRGB(255, 255, 255)
                    })  Items["3"]:AddToTheme({BackgroundColor3 = "Background"})
                    
                    Items["4"] = Instances:Create("Frame", {
                        Parent = Items["LeftBottomPixels"].Instance,
                        Name = "\0",
                        BorderColor3 = FromRGB(0, 0, 0),
                        AnchorPoint = Vector2New(0, 1),
                        ...
                        BorderSizePixel = 0,
                        BackgroundColor3 = FromRGB(255, 255, 255)
                    })  Items["4"]:AddToTheme({BackgroundColor3 = "Background"})
                    
                    Items["5"] = Instances:Create("Frame", {
                        Parent = Items["LeftBottomPixels"].Instance,
                        Name = "\0",
                        BorderColor3 = FromRGB(0, 0, 0),
                        AnchorPoint = Vector2New(0, 1),
                        ...
                        BorderSizePixel = 0,
                        BackgroundColor3 = FromRGB(255, 255, 255)
                    })  Items["5"]:AddToTheme({BackgroundColor3 = "Background"})
                    
                    Items["6"] = Instances:Create("Frame", {
                        Parent = Items["LeftBottomPixels"].Instance,
                        Name = "\0",
                        BorderColor3 = FromRGB(0, 0, 0),
                        AnchorPoint = Vector2New(0, 1),
                        ...
                        BorderSizePixel = 0,
                        BackgroundColor3 = FromRGB(255, 255, 255)
                    })  Items["6"]:AddToTheme({BackgroundColor3 = "Background"})
                    ...
                    Items["7"] = Instances:Create("Frame", {
                        ...
                        BorderSizePixel = 0,
                        BackgroundColor3 = FromRGB(255, 255, 255)
                    })  Items["7"]:AddToTheme({BackgroundColor3 = "Background"})   
                    
                    Items["8"]= Instances:Create("Frame", {
                        Parent = Items["LeftTopPixels"].Instance,
                        Name = "\0",
                        Size = UDim2New(0, 1, 0, 1),
                        BackgroundTransparency = 0.12,
                        ...
                        BorderSizePixel = 0,
                        BackgroundColor3 = FromRGB(255, 255, 255)
                    })  Items["8"]:AddToTheme({BackgroundColor3 = "Background"})   
                    
                    Items["9"]= Instances:Create("Frame", {
                        Parent = Items["LeftTopPixels"].Instance,
                        Name = "\0",
                        Size = UDim2New(0, 1, 0, 1),
                        ...
                        BorderSizePixel = 0,
                        BackgroundColor3 = FromRGB(255, 255, 255)
                    })  Items["9"]:AddToTheme({BackgroundColor3 = "Background"})   
                    
                    Items["10"] = Instances:Create("Frame", {
                        Parent = Items["LeftTopPixels"].Instance,
                        Name = "\0",
                        Size = UDim2New(0, 1, 0, 1),
                        ...
                        BorderSizePixel = 0,
                        BackgroundColor3 = FromRGB(255, 255, 255)
                    })  Items["10"]:AddToTheme({BackgroundColor3 = "Background"})   
                    
                    Items["11"]=Instances:Create("Frame", {
                        Parent = Items["LeftTopPixels"].Instance,
                        Name = "\0",
                        Size = UDim2New(0, 1, 0, 1),
                        ...
                        BorderSizePixel = 0,
                        BackgroundColor3 = FromRGB(255, 255, 255)
                    })  Items["11"]:AddToTheme({BackgroundColor3 = "Background"})   
                    
                    Items["12"] = Instances:Create("Frame", {
                        Parent = Items["LeftTopPixels"].Instance,
                        Name = "\0",
                        Size = UDim2New(0, 1, 0, 1),
                        ...
                        BorderSizePixel = 0,
                        BackgroundColor3 = FromRGB(255, 255, 255)
                    })  Items["12"]:AddToTheme({BackgroundColor3 = "Background"})                                      
                end
            ...
            function Window:Init()
                ...
                local autoSavePath = Library.Folders.Configs .. "/autosave.json"
                pcall(function()
                ...
                for _, Value in Window.Pages do
                    if Value.Active then
                        for , Value2 in Value.Sections do
                            task.spawn(function()
                ...
                -- 4) АВТО-СЕЙВ СЕССИИ: всё, что настроил, само сохраняется в autosave.json
                task.spawn(function()
            ...
            Window.silentLoad = SilentLoadStart   -- читается в Window:Init (открывать ли меню после конфига)
        ...
        Library.Watermark = function(self, Data)
            ...
            for , Child in pairs(ContentFrame:GetChildren()) do
                if Child.Name:find("Item") or Child.Name:find("Sep") then
                    local , IndexStr = Child.Name:match("(%a+)(%d+)")
        ...
        Library.Sections.Slider = function(self, Data)
            ...
            Items["RealSlider"]:Connect("InputBegan", function(Input)
                if Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch then
                    ...
                    Slider.DragPosX = Items["RealSlider"].Instance.AbsolutePosition.X
                    Slider.DragSizeX = Items["RealSlider"].Instance.AbsoluteSize.X

                    local SizeX = (Input.Position.X - Slider.DragPosX) / Slider.DragSizeX
            ...
            Library:Connect(UserInputService.InputChanged, function(Input)
                if Input.UserInputType == Enum.UserInputType.MouseMovement or Input.UserInputType == Enum.UserInputType.Touch then
                    if Slider.Sliding then
                        local PosX = Slider.DragPosX or Items["RealSlider"].Instance.AbsolutePosition.X
                        local SzX = Slider.DragSizeX or Items["RealSlider"].Instance.AbsoluteSize.X
        ...
        Library.Sections.Dropdown = function(self, Data)
            ...
            function Dropdown:Refresh(List, DefaultVal)
                ...
                for , Name in ipairs(OptionsToRemove) do
        ...
        Library.Sections.Listbox = function(self, Data)
            ...
            local Items = { } do 
                ...
                Items[""] = Instances:Create("Frame", {
                    ...
                    BorderSizePixel = 0,
                    BackgroundColor3 = FromRGB(27, 26, 29)
                })  Items[""]:AddToTheme({BackgroundColor3 = "Element"})

                Instances:Create("Frame", {
                    Parent = Items[""].Instance,
                    Name = "\0",
            ...
            function Dropdown:RefreshPosition(Bool)
                if Bool then
                    ...
                    Items[""]:Tween(TweenInfo.new(1, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {Position = UDim2New(0, 0, 0, 25)})
                else
                    Items["Background"].Instance.Position = UDim2New(0, 30, 0, 30)
                    Items["Search"].Instance.Position = UDim2New(0, 30, 0, 0)
                    Items[""].Instance.Position = UDim2New(0, 30, 0, 25)
                end
            end
